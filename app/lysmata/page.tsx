...
export default function LysmataPage() {
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold text-center mb-8">{t.heroTitle}</h2>
            ...
            <p className="text-center text-gray-600 mt-4">{t.heroDesc}</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {t.features.map((item) => (
              <article key={item.title} className="bg-white p-6 rounded-lg shadow-md">
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">{t.architectureTitle}</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {t.architecture.map((item) => (
              <article key={item.title} className="bg-gray-50 p-6 rounded-lg">
                <h3 className="text-xl font-semibold mb-3">{item.title}</h3>
                <p className="text-gray-600">{item.desc}</p>
              </article>
            ))}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-8">{t.systemReqTitle}</h2>
          <div className="max-w-2xl mx-auto">
            <ul className="space-y-4">
              {t.systemReq.map((req, idx) => (
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">{t.installTitle}</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {t.installSteps.map((step, idx) => (
      ...
      <footer className="bg-white py-8 border-t">
        <div className="container mx-auto px-4 text-center">
          <p className="text-gray-600">
            © 2026 Lysmata. Built for OpenClaw.{' '}
            <a
